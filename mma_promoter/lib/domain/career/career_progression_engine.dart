...
class CareerProgressionEngine {
  ...
  /// Standard Elo update. [scoreA] is 1.0 for a win, 0.5 for a draw, 0.0 for
  /// a loss, from fighter A's perspective. Returns the new (eloA, eloB).
  (int, int) updateElo(int eloA, int eloB, double scoreA) {
    final expectedA = 1 / (1 + pow(10, (eloB - eloA) / 400));
