...
const Map<String, _NamePool> _namePoolsByNationality = {
  'USA': _NamePool(
    [
      'James', 'Michael', 'Chris', 'Tyler', 'Josh', 'Kevin', 'Brandon',
      'Derek', 'Cody', 'Blake', 'Colton', 'Travis', 'Wyatt', 'Jace',
      'Tucker', 'Brock', 'Cade', 'Rhett', 'Bryce', 'Clayton', 'Dalton',
      'Austin', 'Beau', 'Chase', 'Garrett', 'Weston', 'Griffin', 'Shane',
      'Devin', 'Trent', 'Sawyer', 'Nash', 'Colby', 'Drew', 'Reid', 'Lane',
      'Brett', 'Heath', 'Troy', 'Holden', 'Dane', 'Kellen', 'Zane', 'Clay',
      'Mack', 'Dean',
    ],
    [
      'Johnson', 'Williams', 'Miller', 'Davis', 'Anderson', 'Thompson',
      'Mitchell', 'Carter', 'Foster', 'Coleman', 'Hayes', 'McKenzie',
      'Callahan', 'Whitaker', 'Brennan', 'Donovan', 'Morrison', 'Calloway',
      'Maddox', 'Mercer', 'Prescott', 'Hargrove', 'Kensington', 'Holloway',
      'Boone', 'Chandler', 'Maddison', 'Lancaster', 'McAllister',
      'Thornton', 'Hollister', 'Rutherford', 'Caldwell', 'Harrington',
      'Sullivan', 'Montgomery', 'Winslow', 'Whitman', 'Fletcher',
      'Stanton', 'Murphy', 'Langford', 'Whitmore',
    ],
  ),
  'Brazil': _NamePool(
    [
      'Thiago', 'Rafael', 'Bruno', 'Anderson', 'Mateus', 'Gabriel', 'Lucas',
      'Renan', 'Vitor', 'Diego', 'João', 'Pedro', 'Matheus', 'Felipe',
      'Gustavo', 'André', 'Daniel', 'Eduardo', 'Vinícius', 'Henrique',
      'Leonardo', 'Marcelo', 'Caio', 'Rodrigo', 'Fernando', 'Carlos',
      'Arthur', 'Guilherme', 'Murilo', 'Samuel', 'Victor', 'Renato',
      'Igor', 'Cristiano', 'Ricardo', 'Fábio', 'Wesley', 'Douglas',
      'Ramon', 'Danilo', 'Leandro', 'Alexandre', 'Márcio', 'Robson',
      'Everton', 'Luan', 'Nicolas', 'Enzo', 'Bernardo', 'Davi', 'Miguel',
      'Heitor', 'Lorenzo', 'Joaquim', 'Bento', 'Raul', 'Otávio', 'Marcos',
      'Paulo', 'José', 'Antônio', 'Luiz',
      // Compound given names are common in Brazil and read as one unit.
      'João Vitor', 'João Gabriel', 'Pedro Henrique', 'Paulo Henrique',
      'Marcos Vinícius', 'Luiz Felipe', 'José Eduardo', 'Antônio Carlos',
      'Victor Hugo',
    ],
    [
      'Silva', 'Santos', 'Oliveira', 'Souza', 'Costa', 'Pereira', 'Almeida',
      'Ferreira', 'Rodrigues', 'Barbosa', 'Carvalho', 'Gomes', 'Martins',
      'Ribeiro', 'Rocha', 'Dias', 'Teixeira', 'Moreira', 'Mendes',
      'Nascimento', 'Araújo', 'Vieira', 'Castro', 'Lima', 'Cardoso',
      'Correia', 'Monteiro', 'Freitas', 'Ramos', 'Fernandes', 'Alves',
      'Andrade',
    ],
  ),
  'Russia': _NamePool(
    [
      'Viktor', 'Dmitri', 'Nikolai', 'Sergei', 'Ivan', 'Alexei', 'Pavel',
      'Yuri', 'Oleg', 'Maxim', 'Alexander', 'Dmitry', 'Mikhail', 'Andrei',
      'Vladimir', 'Roman', 'Denis', 'Artem', 'Kirill', 'Anton', 'Ilya',
      'Boris', 'Konstantin', 'Evgeny', 'Vasily', 'Grigory', 'Vadim',
      'Stanislav', 'Timur', 'Sergey', 'Fyodor',
    ],
    [
      'Volkov', 'Petrov', 'Sokolov', 'Ivanov', 'Kuznetsov', 'Popov',
      'Smirnov', 'Novikov', 'Fedorov', 'Orlov', 'Morozov', 'Mikhailov',
      'Kozlov', 'Lebedev', 'Semyonov', 'Egorov', 'Pavlov', 'Vasiliev',
      'Zaitsev', 'Solovyov', 'Vinogradov', 'Bogdanov', 'Voronin', 'Krylov',
      'Maksimov', 'Belov', 'Komarov', 'Tarasov', 'Baranov', 'Medvedev',
      'Nikitin', 'Karpov', 'Zakharov', 'Makarov', 'Andreev', 'Denisov',
      'Tikhonov', 'Gusev', 'Antonov', 'Belyaev', 'Danilov', 'Kolesnikov',
      'Afanasyev', 'Ershov', 'Gavrilov', 'Mironov', 'Filatov', 'Korolev',
      'Kuzmin', 'Frolov', 'Abramov', 'Maslov', 'Osipov', 'Titov', 'Panov',
      'Sorokin', 'Chernov', 'Zhuravlev', 'Loginov', 'Romanov',
      'Shcherbakov', 'Vlasov', 'Kiselev', 'Trofimov', 'Savelyev', 'Kalinin',
      'Bondarenko', 'Shapovalov', 'Fadeev', 'Yudin', 'Bortnikov',
      'Marchenko', 'Stepanov', 'Belousov',
    ],
  ),
  'Poland': _NamePool(
